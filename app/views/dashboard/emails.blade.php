        ...
        <div class="row newsletter">
          	<div class="col-lg-12 emails-page">
                <ul class="nav nav-tabs" id="emailsTab">
                    <li class="active">
                        <a href="#compose" class="compose" rel="{{URL::to('dashboard/emails/compose-email')}}">Compose Email</a>
                    </li>
                    <li>
                        <a href="#sent" class="sent">Sent Emails <span class="badge">{{$emails->count()}}</span></a>
                    </li>
                    <li>
