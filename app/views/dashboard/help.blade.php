...
@section('page')
    ...
    <div class="jumbotron">
        <center><h1><span class="glyphicon glyphicon-bullhorn"></span> Heddfdlp</h1></center>
    </div>         
            ...
            <form class="form-horizontal help-form" action="{{URL::to('dashboard/help')}}" method="post">  
                ...
                <div class="form-group">
                    <div class="col-lg-10 col-lg-offset-2">
                        <button type="submit" class="btn btn-primary btn-lg" id="process-email" >SEND FOR HELP</button>
                    </div>
                </div>                                                     
            </form> 
            <script>
