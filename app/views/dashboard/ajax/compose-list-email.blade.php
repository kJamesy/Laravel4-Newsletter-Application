...
<form class="form-horizontal compose-email-form" action="{{URL::to('dashboard/lists/send-email/1')}}">    
    ...
    <div class="form-group">
        <div class="col-lg-10 col-lg-offset-2">
            <button type="submit" class="btn btn-primary btn-lg" id="process-email" ><span class="glyphicon glyphicon-plane"></span> SEND</button>
        </div>
    </div>                                                       
</form> 
<script>
