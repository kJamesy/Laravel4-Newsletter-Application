			...
			<div class="row">
				<div class="col-lg-6">
					...
					@else
						...
						<br /><br /><a class="btn btn-primary" href="{{URL::to('dashboard/emails')}}">Send an email &rarr;</a>
					@endif                    
				</div> 
				<div class="col-lg-6">
					@if ($impressions > 0)
			...
			<div class="row">
				<div class="col-lg-6">
					...
					@else
						...
						<br /><br /> <a class="btn btn-primary" href="{{URL::to('dashboard/subscribers')}}">Add subscribers &rarr;</a>
					@endif
				</div> 
