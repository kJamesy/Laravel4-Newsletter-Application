        ...
        <div class="modal fade" id="delete-sub">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal delete-sub-form" action="{{URL::to('dashboard/subscribers/delete')}}">
                            <div class="panel panel-info panel-delete-sub col-lg-12">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Select Subscriber to Delete</h3>
                                </div> 
                                <div class="panel-message"></div><br />
                                <select class="form-control update-sub" id="select-sub-delete">
                                    @foreach($subscribers as $subscriber)
                                        <option  value="{{$subscriber->id}}">
                                            {{$subscriber->first_name . ' ' . $subscriber->last_name}} &lt;{{$subscriber->email}}&gt; 
                                        </option>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancel</button>
                        <button type="button" class="btn btn-danger" id="delete-sub-btn" rel="" disabled>
